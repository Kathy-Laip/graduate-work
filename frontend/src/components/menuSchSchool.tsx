                ...
                <div className="sch">
                    ...
                    {week.map((el, ind) => (
                        <>
                            ...
                            {arrHours !== undefined && arrHours !== 0 && (<LineVertical height={(arrHours!.length*75 + 140)+'px'} top='0px' left={(70 + ind*180*Number(Object.values(props.sch.settings!.arr_courses[course] || 0).filter(el => el[0]).length))+'px'}/>)}
                            {Object.values(props.sch.settings!.arr_courses[course] || 0).filter(el => el[0]).map((el, ind1) => (
                                <>
                                    ...
                                    {arrHours !== undefined && arrHours !== 0 && ind1 !== 0 && (<LineVertical height={(arrHours!.length*75 + 85)+'px'} top='55px' left={(ind*180*Number(Object.values(props.sch.settings!.arr_courses[course] || 0).filter(el => el[0]).length)) + (ind1*180) + 65 +'px'}/>)}
                                </>
